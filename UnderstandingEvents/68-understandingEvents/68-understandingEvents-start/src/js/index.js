...
morningBtn.addEventListener(
    'click', ()=> (greeting.innerText = 'Good Morning'));

dayBtn.addEventListener(
    'click', ()=> (greeting.innerText = 'Good Day'));

afternoonBtn.addEventListener(
    'click', ()=> (greeting.innerText = 'Good Afternoon'));

eveningBtn.addEventListener(
    'click', ()=> (greeting.innerText = 'Good Evening'));

nightBtn.addEventListener(
    'click', ()=> (greeting.innerText = 'Good Night'));
