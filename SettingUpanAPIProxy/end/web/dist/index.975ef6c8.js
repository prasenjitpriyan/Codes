...
addTaskInput.addEventListener("keyup", async (evt)=>{
    ...
    if (evt.key === "Enter") {
        ...
        if (newTask) {
            const tasks = await (0, _model.addTask)(newTask);
            evt.target.value = "";
            (0, _viewDefault.default)(tasks, taskList);
        }
    }
});
taskList.addEventListener("click", async (evt)=>{
    if (evt.target.classList.contains("rem-btn")) {
        ...
        const tasks = await (0, _model.removeTask)(id);
        (0, _viewDefault.default)(tasks, taskList);
    }
});
(async ()=>{
    const tasks = await (0, _model.getTasks)();
    // const parsed = await tasks.json();
    (0, _viewDefault.default)(tasks, taskList);
})();

},{"./view":"ai2uB","./model":"dEDha","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ai2uB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>render);
const itemTemplate = (id, task)=>`<div class="task">${task}<div class="rem-btn" data-id="${id}">❌</div></div>`;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["igKGj","8lqZg"], "8lqZg", "parcelRequire2d1f")
