...
exports.getCompletedList = exports.getShoppingList = exports.removeItem = exports.setPriority = exports.addToCompletedList = exports.addToShoppingList = void 0;
let shoppingList = [];
let completedList = [];
...
const removeItem = itemId => shoppingList = shoppingList.filter(({
  id
}) => id === itemId);
