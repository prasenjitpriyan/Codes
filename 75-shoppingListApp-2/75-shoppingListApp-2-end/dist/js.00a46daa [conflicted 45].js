...
exports.getCompletedList = exports.getShoppingList = exports.clearCompleted = exports.removeItem = exports.setPriority = exports.addToCompletedList = exports.addToShoppingList = void 0;
let shoppingList = [];
let completedList = [];
...
shoppingListDiv.addEventListener('click', function (evt) {
  ...
  if (evt.target.classList.contains('remove-btn')) {
    ...
    if ((0, _dataModel.removeItem)(itemId)) {
      (0, _view.renderShoppingList)();
    }
  }
});
