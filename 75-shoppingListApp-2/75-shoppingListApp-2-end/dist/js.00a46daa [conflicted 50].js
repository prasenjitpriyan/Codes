...
const saveToStore = function (shopping, completed) {
  window.localStorage.setItem('shoppingApp_active', JSON.stringify(shopping, completed));
  window.localStorage.setItem('shoppingApp_completed', JSON.stringify(data));
};

exports.saveToStore = saveToStore;

const getFromStore = function () {
  const getData = window.localStorage.getItem('shopping_app');
