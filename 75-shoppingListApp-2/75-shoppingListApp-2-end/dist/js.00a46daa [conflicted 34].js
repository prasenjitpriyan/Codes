...
const renderShoppingList = () => {
  const domNodes = (0, _dataModel.getShoppingList)().map(({
    item,
    priority,
    id
  }) => {
...
const renderCompletedList = () => {
  const domNodes = (0, _dataModel.getCompletedList)().map(({
    item,
    priority,
    id
  }) => {
...
},{"./dataModel":"js/dataModel.js","./Item":"js/Item.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
